...
class simple_controller :
    ...
    def laser_callback(self,msg):
        ...
        for point in pcd.points :
            if point.x > 0 and point.x < 1.7 :
                if point.y > -1.2 and point.y < 1.2 :
                    count=count+1

        if count > 20 :
            if msg.ranges[45] > msg.ranges[130:150]:
                motor_msg.data = 2000
                servo_msg.data = 0.15
            elif msg.ranges[135] > msg.ranges[30:50]:
                motor_msg.data = 2000
                servo_msg.data = 0.85
#            motor_msg.data = 0
...
#        if motor_msg.data == 0 :
#            if msg.ranges[45] > msg.ranges[135]:
#                motor_msg.data = 2000
#                servo_msg.data = 0.15
#            elif msg.ranges[135] > msg.ranges[45]:
#                motor_msg.data = 2000
#                servo_msg.data = 0.85
